    ...
    >
      <Layout>
        <Flex w="100%" flexDir="column" alignItems="center" minH="860px">
          ...
          <Text color="gray.700" mt="20" fontSize="30px" fontWeight="700">
            Page not found!
          </Text>
          <Flex mt="4">
            <HStack spacing="6">
            <Link to="/">
              <Button bg="#F774B9" color="#fff" h="37px" rounded="12">go home</Button>
            </Link>
            <Link to="/explore">
            <Button bg="#fff" color="#F774B9" h="37px" rounded="12">go back</Button>
            </Link>
            </HStack>
          </Flex>
        </Flex>
